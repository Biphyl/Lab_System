...
from student_management import views, HodViews, StaffViews, StudentViews
from student_management.EditResultVIewClass import EditResultViewClass
from Lab_System import settings
